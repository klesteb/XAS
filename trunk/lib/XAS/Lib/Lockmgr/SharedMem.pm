package XAS::Lib::Lockmgr::SharedMem;
...
XAS::Lib::Lockmgr::SharedMem - Use SysV IPC for resource locking.
...
=item L<https://metacpan.org/pod/IPC::Semaphore|IPC::Semaphore>

=item L<https://metacpan.org/pod/IPC::SharedMem|IPC::SharedMem>
...
Copyright (C) 2015 by Kevin L. Esteb
