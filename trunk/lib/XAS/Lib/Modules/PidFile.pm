package XAS::Lib::Modules::PidFile;
...
BEGIN {
    $mixin = 'XAS::Lib::Modules::PidFile::Unix';
    $mixin = 'XAS::Lib::Modules::PidFile::Win32' if ($^O eq 'MSWin32');
}
...
XAS::Lib::Modules::PidFile - A class to manage pid files within XAS

=head1 SYNOPSIS

  use XAS::Lib::Modules::PidFile;

  my $pid = XAS::Lib::Modules::PidFile->new(
