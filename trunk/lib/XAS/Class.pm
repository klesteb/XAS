...
L<XAS::Utils|XAS::Utils>. Which inherits from L<Badger::Constants|http://search.cpan.org/~abw/Badger-0.09/lib/Badger/Class.pm> and 
L<Badger::Utils|http://search.cpan.org/~abw/Badger-0.09/lib/Badger/Utils.pm>.
